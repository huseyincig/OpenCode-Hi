...
test('parser identifies the exact invalid closed-list field without widening diagnosis semantics',()=>{
...
test('parser keeps other closed-list fields fail-closed with field-scoped diagnostics',()=>{
...
test('task_kind remains independently field-specific and invalid intent signals stay explicit',()=>{
