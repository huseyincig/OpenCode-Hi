...
function runtime(prompts,resources=new Set()){return new TaskRuntime(opencodeChildPort(client(prompts)),new BackgroundRegistry(),new ConcurrencyScheduler(()=>({global:2,providers:{},models:{}})),repoRoot,repoRoot,()=>DEFAULT_HI_CONFIG,()=>[],()=>structuredClone(HOST),undefined,{},undefined,undefined,()=>resources)}
