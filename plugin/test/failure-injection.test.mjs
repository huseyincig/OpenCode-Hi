...
test('exact OpenCode 1.18.20 named errors outrank legacy text heuristics',()=>{
  ...
  const aborted=classifyWorkerFailure({name:'MessageAbortedError',message:'aborted'});assert.deepEqual([aborted.kind,aborted.retryable,aborted.stagnation],['host-interruption',true,false])
})
