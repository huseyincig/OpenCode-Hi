...
test('execution capacity config changes real topology and scheduler decisions',()=>{
...
test('routing constraints execute while legacy scoring/model-mode fields are diagnostic-only',()=>{
