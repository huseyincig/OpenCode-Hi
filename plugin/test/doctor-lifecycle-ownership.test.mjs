...
test('doctor flags role mapping with no runtime-available candidate',()=>{
  ...
  try{
    const cfg={schemaVersion:2,executionPolicy:'adaptive',primaryMode:'auto',compatibility:{mode:'compatible',validatedOpenCodeVersions:[]},routing:{strategy:'cost-quality',categoryModels:{},categoryVariants:{},roleModels:{coder:['p/missing']},roleVariants:{},modelPolicy:'adaptive',adaptiveRoles:[],maxFallbacks:3,allowedProviders:[],deniedModels:[]},parallel:{enabled:true,max:3,providers:{},models:{}},teamMode:{enabled:false,auto:false,maxMembers:4,maxMessages:24,maxTurns:12,maxWallMinutes:45},profile:{minimal:{specialistThreshold:'high',parallelThreshold:'high',reviewThreshold:'low',costSensitivity:'high',qualityFloor:'standard'},balanced:{specialistThreshold:'medium',parallelThreshold:'medium',reviewThreshold:'medium',costSensitivity:'medium',qualityFloor:'standard'},thorough:{specialistThreshold:'low',parallelThreshold:'low',reviewThreshold:'high',costSensitivity:'low',qualityFloor:'high'}}}
