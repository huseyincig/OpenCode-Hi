...
test('browser execution custom tools are default-off and only active visual workers may pass the child guard',async()=>{
  ...
  m.execution.tasks.push({id:'t_visual',mission_id:m.identity.mission_id,objective:'visual',status:'running',role:'visual-qa',category:'visual',scope:[],constraints:[],dependencies:[],requiredEvidence:[],obligation_ids:[],context_artifacts:[],execution_profile:{browser_backend:'bounded-playwright'},gate_ids:[],external_action_requirements:[],worker_id:'w_visual',created_at:Date.now(),updated_at:Date.now()})
