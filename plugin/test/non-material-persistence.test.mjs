...
test('non-material assessment persists normalized intent instead of assessed/unclassified state',()=>{
  ...
  try{
    ...
    store.applyInitialSemanticAssessment('non-material-review',{material:false,message_kind:'non-material',task_kind:'review',scope:'local',risk:'low',ambiguity:'none',dependency_class:'independent',required_capabilities:[],requested_external_actions:[],likely_verification:[],likely_targets:[],intent_signals:[],suppressed_intent_signals:[]})
    ...
    assert.deepEqual(m.identity.intent.requiredCapabilities,[])
