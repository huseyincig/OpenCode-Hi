...
test('review evidence is fenced from non-reviewer analysis and implementation handoffs without weakening explorer clearance',async()=>{
  for(const [suffix,role,kind] of [['analysis','repository-explorer','analysis'],['implementation','coder','implementation']]){
    ...
    assess(store,sid,{task_kind:'bug-fix',scope:'multi-file',ambiguity:'none',required_capabilities:['repository-analysis','implementation','verification'],likely_targets:['index.html'],likely_verification:['review-evidence']})
...
test('distinct visual verification owner keeps mission visual evidence off analysis and implementation task handoffs',async()=>{
  ...
  assess(store,'distinct-visual-owner',{task_kind:'bug-fix',scope:'multi-file',ambiguity:'none',required_capabilities:['repository-analysis','implementation','verification','visual-qa'],likely_targets:['index.html'],likely_verification:['visual-check']})
...
test('model task evidence cannot widen beyond canonical mission verification admission',async()=>{
  ...
  assess(store,'model-evidence-widening',{task_kind:'bug-fix',scope:'multi-file',ambiguity:'none',required_capabilities:['repository-analysis','implementation','verification','visual-qa'],likely_targets:['index.html'],likely_verification:['visual-check']})
