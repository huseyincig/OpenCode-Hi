...
test('MissionRuntimeProjection exposes only the bounded dynamic runtime fields',()=>{
...
test('parallel runtime projection makes scheduler-owned delegation explicit before parent mutation',()=>{
...
test('stable policy lives in generated OpenCode agent projections while dynamic state stays separate',()=>{
...
test('system transform splits stable policy and dynamic runtime block',async()=>{
...
test('changed-file state preserves pre-existing user ownership and verification/review state',()=>{
