...
export const HiPlugin = async (ctx) => {
    ...
    try {
        ...
        return createOpenCodeHooks({ state: runtime.state, host, services: runtime.services, projectRoot, workingDirectory: ctx.directory, packagedSkillsDir: runtime.packagedSkillsDir, projectAuthority: runtime.projectAuthority, toolSurface: runtime.toolSurface, eventController: runtime.eventController, instanceLease });
    }
    catch (error) {
