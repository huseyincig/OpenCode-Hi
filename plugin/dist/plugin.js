...
export const HiPlugin = async (ctx) => {
    ...
    const { toolSurface, reconfigure } = createHiToolSurface({ state, store: services.store, tasks: services.tasks, teams: services.teams, projectRoot, capabilities: host.capabilities, native: host.native, getModels: host.getModels });
