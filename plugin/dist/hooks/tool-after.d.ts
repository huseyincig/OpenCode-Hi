...
export declare function createToolAfterHook(store: MissionStore, background?: BackgroundRegistry, events?: RuntimeSignalSink, projectRoot?: string): (input: any, output: any) => Promise<void>;
