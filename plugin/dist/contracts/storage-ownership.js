...
export const STORAGE_OWNERSHIP_CATALOG = [
    ...
    { data_class: 'durable-context-artifact', canonical_owner: 'hi-context-artifact', scope: 'project', lifecycle: 'derived', path_provider: '.opencode/hi/artifacts/<kind>/<artifact_id>.json', schema_ref: 'ArtifactContract', write_owner: 'ContextArtifactStore', readers: ['ContextArtifactStore', 'TaskRuntime'], retention: 'artifact retention_class', privacy: 'artifact privacy_class' },
