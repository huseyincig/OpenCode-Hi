...
export function isEvidenceItemContract(v) {
    ...
    if (scopeStateHash !== undefined && (typeof scopeStateHash !== 'string' || !/^[a-f0-9]{64}$/i.test(scopeStateHash)))
        return false;
    if (v.trusted_source_class !== undefined && (typeof v.trusted_source_class !== 'string' || !SOURCE_CLASS_SET.has(v.trusted_source_class)))
        return false;
