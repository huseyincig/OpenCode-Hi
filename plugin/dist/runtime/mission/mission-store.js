...
export class MissionStore {
    ...
    applyInitialSemanticAssessment(sessionID, assessment) {
        ...
        m.adaptive_execution = { path: adaptive.path, reasons: adaptive.reasons };
        m.topology = { mode: topology.mode, parallelism: topology.parallelism, reason: topology.reason };
