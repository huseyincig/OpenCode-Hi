...
export class MissionStore {
    ...
    start(sessionID, userText, observedPrimary) {
        ...
        const mission = {
            ...
            execution: { execution_mode: 'single', primary_mode: primary, verification_policy: { requiredKinds: [], requireFresh: true, requireReview: false, allowWorkerReportedEvidence: true }, adaptive_execution: { path: 'DIRECT', reasons: ['semantic assessment pending'] }, topology: { mode: 'single-agent', parallelism: 1, reason: ['semantic assessment pending'] }, obligations: [], tasks: [], workers: [], processes: [], evidence: { fresh: false, items: [] }, ledger: [], blockers: [], constraints: [], native_todos_incomplete: 0, gates: [] },
