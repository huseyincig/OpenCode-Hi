...
export class MissionStore {
    ...
    applyInitialSemanticAssessment(sessionID, assessment) {
        ...
        m.topology = { mode: topology.mode, agentCount: topology.agentCount, parallelism: topology.parallelism, reason: topology.reason };
