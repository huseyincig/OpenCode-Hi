...
function policyFilter(available, config, hostConfig) {
...
export function runtimeModelCandidateStatus(id, availableInput, config, hostConfig) {
    ...
    const checked = policyFilter([candidate], config, hostConfig);
...
export function resolveModel(category, availableInput, config, explicit, role, hostConfig, feedback = {}) {
    ...
    if (!availableInput.length) {
        ...
        if (!deniedDefault && !config.routing.allowedProviders.length) {
