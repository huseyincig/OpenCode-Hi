...
export declare function verificationOnlyExecutionSurface(surface: EffectiveExecutionSurface): EffectiveExecutionSurface;
...
export declare const HI_PROCESS_EXECUTION_TOOL_IDS: readonly ["hi_process_spawn", "hi_process_read", "hi_process_write", "hi_process_wait", "hi_process_kill", "hi_process_cleanup", "hi_process_list"];
export declare const HI_CONTROL_TOOL_IDS: readonly ["hi_doctor", "hi_status", "hi_settings", "hi_role_models", "hi_metrics", "hi_super_product", "hi_ledger", "hi_readiness", "hi_context_artifact_add", "hi_context_artifacts", "hi_temporary_mutation_register", "hi_temporary_mutation_revert", "hi_direct_progress", "hi_task_start", "hi_task_await", "hi_task_peek", "hi_task_list", "hi_task_cancel"];
export declare const HI_RUNTIME_TOOL_IDS: readonly ["hi_doctor", "hi_status", "hi_settings", "hi_role_models", "hi_metrics", "hi_super_product", "hi_ledger", "hi_readiness", "hi_context_artifact_add", "hi_context_artifacts", "hi_temporary_mutation_register", "hi_temporary_mutation_revert", "hi_direct_progress", "hi_task_start", "hi_task_await", "hi_task_peek", "hi_task_list", "hi_task_cancel", "hi_intent_assess", "hi_process_spawn", "hi_process_read", "hi_process_write", "hi_process_wait", "hi_process_kill", "hi_process_cleanup", "hi_process_list", "hi_browser_preview_open", "hi_browser_open", "hi_browser_navigate", "hi_browser_click", "hi_browser_type", "hi_browser_key", "hi_browser_inspect", "hi_browser_viewport", "hi_browser_screenshot", "hi_browser_wait", "hi_browser_close"];
