const Hi_CUSTOM_ROLE_REQUIREMENTS = {
...
export function auditNativeAgentReuse(role) {
    ...
    if (reasons?.length)
        return { role, decision: 'hi-custom-required', reasons };
...
export function knownHiCustomRoles() { return Object.keys(Hi_CUSTOM_ROLE_REQUIREMENTS).sort(); }
