import { type BuildComparativeBenchmarkCertificationSeriesInput, type ComparativeBenchmarkCertificationSeries } from '../../contracts/comparative-benchmark-certification.js';
import { type BenchmarkScenarioResult, type RecoveryGovernorAblationResult, type SchedulerEconomicsResult } from '../telemetry/benchmarks.js';
export interface BehavioralEvaluationPlatformView {
    certification: ComparativeBenchmarkCertificationSeries;
    deterministic_policy_evidence: {
        runtime: BenchmarkScenarioResult[];
        scheduler: SchedulerEconomicsResult[];
        recovery: RecoveryGovernorAblationResult;
    };
    boundaries: {
 ...
 */
export declare function behavioralEvaluationPlatform(input: BuildComparativeBenchmarkCertificationSeriesInput): BehavioralEvaluationPlatformView;
