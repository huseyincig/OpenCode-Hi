...
export function beginWorkerAttempt(task, worker, at = Date.now()) { worker.attempt = (worker.attempt ?? 0) + 1; worker.started_at = at; delete worker.last_result_digest; delete worker.last_result_at; worker.attempt_prompt_message_id = workerAttemptPromptMessageID(worker, at); worker.updated_at = at; task.updated_at = at; }
