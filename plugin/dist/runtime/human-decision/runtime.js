import { humanDecisionId, isHumanDecisionContract } from '../../contracts/human-decision.js';
...
export function openHumanDecision(m, input) {
    ...
    if (!isHumanDecisionContract(decision))
        throw new Error('Invalid or semantically incoherent HumanDecision contract');
