...
export function renderSemanticAssessmentGate(m) {
    ...
    return [
        ...
        'diagnosis=no-fix;review=no-write;review+fix=>bug-fix+C:implementation;local release=>bug-fix;docs=>C:documentation;verify!=test-authoring;intent.debugging=>diagnosis+repository-analysis;independent-review=explicit/risk;interactive-process=persistent;X nonempty=>risk=authority-boundary',
        phaseRule,
    ].join('\n');
}
