...
export function renderSemanticAssessmentGate(m) {
    ...
    return [
        ...
        'diagnosis=no-fix;review=no-write;review+fix=>bug-fix+C:implementation;docs=>C:documentation;verify!=test-authoring;intent.debugging=>diagnosis+repository-analysis;independent-review=explicit/risk;interactive-process=persistent;X=>risk=authority-boundary',
        phaseRule,
    ].join('\n');
}
