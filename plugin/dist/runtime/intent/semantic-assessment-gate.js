...
export function renderSemanticAssessmentGate(m) {
    ...
    return [
        ...
        `rev=${semantic.revision};phase=${semantic.phase}; call hi_intent_assess once; hi_role_models is only for an explicit user request to show/configure Hi child-role models, never for normal runtime discovery; user language; no keyword heuristic.`,
