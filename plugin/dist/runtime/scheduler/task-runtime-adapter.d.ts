...
export declare function taskRuntimeAdmittedModel(m: MissionState, worker: WorkerState, models: string[], scheduler: ConcurrencyPolicySource, peerView?: ProjectSchedulingPeerView): string | undefined;
