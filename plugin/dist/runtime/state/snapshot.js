...
export function compactMissionContext(m, worker) {
    ...
    const protectedEntries = essential.map((text, i) => ({ id: `essential-${i}`, kind: 'mission-survival', text, contextClass: 'PROTECTED', createdAt: m.updated_at }));
