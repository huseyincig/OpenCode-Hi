...
export const MODEL_ROUTED_CHILD_ROLES = ['coder', 'architect', 'repository-explorer', 'researcher', 'technical-writer', 'test-engineer', 'qa-reviewer', 'security-reviewer', 'visual-qa'];
