...
export const HiPlugin:Plugin=async(ctx)=>{
  ...
  const refreshOwnedHostCapability=async(id:'process-lifecycle'|'workspace-isolation-binding')=>id==='process-lifecycle'?observeProcessCapability():observeWorkspaceCapability()
