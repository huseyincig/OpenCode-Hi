...
export interface MissionExecutionState {
  ...
  obligations:Obligation[]; tasks:MissionTask[]; workers:WorkerState[]; processes:ProcessContract[]; evidence:{fresh:boolean;items:EvidenceItem[];last_mutation_at?:number}; ledger:LedgerEvent[];
