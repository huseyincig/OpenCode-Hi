...
export interface SuperProductIntegrationView{
  ...
  behavioral_evaluation:{mode:'explicit-receipt-driven';attached:boolean;claim_boundary?:BehavioralEvaluationPlatformView['claim_boundary'];verdict?:string;authority:'evaluation-only'}
