...
export function boundMissionSurvivalSections(sections:string[],maxChars:number=DEFAULT_CONTEXT_BUDGET.max_context_chars):string{return clipText(sections.join('\n'),maxChars)}
