...
function projectResources(task:MissionTask,worker:WorkerState|undefined):ExecutionResourceSelection|undefined{
  if(!worker&&!task.execution_profile)return undefined
