...
export function renderSemanticAssessmentGate(m:MissionState):string{
  ...
  return[
    ...
    `rev=${semantic.revision};phase=${semantic.phase}; call hi_intent_assess once; hi_settings only for config; hi_role_models legacy; user language; no keyword heuristic.`,
