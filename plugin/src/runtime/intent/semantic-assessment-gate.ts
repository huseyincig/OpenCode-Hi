...
export function renderSemanticAssessmentGate(m:MissionState):string{
  ...
  return[
    ...
    `rev=${semantic.revision};phase=${semantic.phase}; call hi_intent_assess once; hi_role_models only on explicit config request; user language; no keyword heuristic.`,
