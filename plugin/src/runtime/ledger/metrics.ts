...
import { missionCausalUsageAttribution,type MissionCausalUsageAttribution } from '../economics/causal-attribution.js'
...
export interface MissionMetrics {
  ...
  usage:{complete_observations:number;partial_observations:number;exact_complete_tokens:{input:number;output:number;reasoning:number;cache_read:number;cache_write:number};derived_opencode_cost_usd:number;monetary_basis:'opencode-calculated-derived';causal:MissionCausalUsageAttribution}
}
