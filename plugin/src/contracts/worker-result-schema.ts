...
export function workerResultOutputFormat():{type:'json_schema';schema:Record<string,unknown>;retryCount:0}{return{type:'json_schema',schema:WORKER_RESULT_JSON_SCHEMA,retryCount:0}}
