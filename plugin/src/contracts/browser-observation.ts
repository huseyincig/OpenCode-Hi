...
export const BROWSER_OBSERVATION_ACTIONS=['open','navigate','click','type','key','inspect','screenshot','wait','close'] as const
...
export function browserObservationId(input:{task_id:string;executor_version:string;url:string;action:BrowserObservationAction;timestamp:number;document_identity?:string;screenshot_artifact_ref?:string;result:BrowserObservationResult}):string{
