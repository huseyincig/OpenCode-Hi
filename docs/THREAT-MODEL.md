...
| `Q3-ADV-013` | `workspace-cleanup-loss` | IsolationDecision / WorkspaceLease contracts + HostCapability; W2 adapter pending | W1 owns strict decision/lease lifecycle metadata only; support stays UNSUPPORTED until W2 execution binding and W3 real-host cleanup proof. | T3 |
