...
|---|---|---|---|
| `browser-execution` | **SUPPORTED_T3** | `8c3f029bf3503f80bde7e1aaa44efe9530260d50` | `data/validation/external-opencode-hi-0.1.0-browser-1.18.18-head-8c3f029.json` |
| `process-lifecycle` | **SUPPORTED_T3** | `8c3f029bf3503f80bde7e1aaa44efe9530260d50` | `data/validation/external-opencode-hi-0.1.0-process-1.18.18-head-8c3f029.json` |
| `workspace-isolation-binding` | **SUPPORTED_T3** | `8c3f029bf3503f80bde7e1aaa44efe9530260d50` | `data/validation/external-opencode-hi-0.1.0-workspace-1.18.18-head-8c3f029.json` |
