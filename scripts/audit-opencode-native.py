...
def main()->int:
    ...
    decisions=[
      ...
      {'surface':'skill-loading','native':'OpenCode Skill service/discovery + native skill tool','hi_decision':'KEEP_POLICY_SELECTION_ONLY','reason':'OpenCode owns skill discovery/loading; Hi owns methodology admission and bounded native-skill selection without a second persistent skill index or loader.','hi_paths':['plugin/src/runtime/skills/registry.ts','plugin/src/runtime/methodology/native-loading.ts']},
