...
checks=[
 ...
 ('push-tag-release-publish-deploy-authority','plugin/src/runtime/safety/command-classifier.ts','ExternalCommandKind','plugin/test/project-authority-persistence.test.mjs','global host ASK remains authoritative for local and external actions even when Hi has a persistent grant'),
