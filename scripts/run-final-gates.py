...
checks={'python':py.returncode==0 and bool(pm),'node':node.returncode==0 and bool(nm) and nm[0]==nm[1] and nm[2]=='0' and nm[3]=='0','architecture':arch.returncode==0 and bool(am),'docs':docs.returncode==0 and bool(dm) and dm.group(2)=='0'}
