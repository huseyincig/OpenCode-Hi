...
checks=[
 ...
 ('project-learning-ready','plugin/src/runtime/methodology/project-policy.ts',"candidate.state!=='READY'",'plugin/test/project-methodology-admission-contract.test.mjs','project-learning provenance without a READY repeated-evidence candidate is not admitted'),
...
static={
 ...
 'project_learning_requires_ready':"candidate.state!=='READY'" in policy,
