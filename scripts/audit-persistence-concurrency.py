...
checks=[
 ...
 (16,'continuation-ephemeral-reset','plugin/src/runtime/mission/mission-store.ts','m.continuation.continuation_active=false','plugin/test/prompt-b-persistence-restart-hostile.test.mjs','unclean restore invalidates only ephemeral/freshness state'),
