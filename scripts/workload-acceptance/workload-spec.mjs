...
export function assertWorkloadSpec(spec){
  for(const key of ['id','title','difficulty','visiblePrompt','fixture','requiredCapabilities','hiddenOracle','requiredEvidence','cleanup'])if(spec[key]===undefined)throw new Error(`WORKLOAD_SPEC_MISSING:${key}`)
