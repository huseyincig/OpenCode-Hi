...
const ACTIVE=existsSync(resolve(ROOT,'.agent-work/workload-acceptance'))
const ALLOW_ACTIVE=process.env.W_HARNESS_CERTIFY_ACTIVE_NAMESPACE_OK==='1'
if(ACTIVE&&!ALLOW_ACTIVE)throw new Error('ACTIVE_W_NAMESPACE_PRESENT')
...
if(!ACTIVE&&existsSync(resolve(ROOT,'.agent-work/workload-acceptance')))throw new Error('W_NAMESPACE_CREATED_DURING_CERTIFICATION')
