...
CHECKS=[
 ...
 ('task-recovery','plugin/src/runtime/task/task-recovery-coordinator.ts','recoverRuntimeFailure','plugin/test/crash-restart-survival.test.mjs','explicit task restart reuses the quarantined child session and only then unlocks its callbacks'),
