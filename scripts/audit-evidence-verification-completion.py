...
checks=[
 ...
 ('source-revision','plugin/src/runtime/task/task-result-reconciler.ts','source_state_hash:browserStateHash??worker.native_state_hash','plugin/test/native-diff-ownership.test.mjs','PROMPT B final native diff deterministically binds worker evidence source-state identity'),
