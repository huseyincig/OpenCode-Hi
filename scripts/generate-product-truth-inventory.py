...
('semantic-context','SemanticContextAdapter','plugin/src/runtime/semantic/adapter.ts',['plugin/src/runtime/semantic/typescript-context.ts','plugin/src/contracts/semantic-context.ts'],['plugin/src/runtime/task/task-runtime.ts'],['plugin/test/c6-semantic-context-adapter.test.mjs'],'docs/ARCHITECTURE.md'),
...
('privacy','PrivacyBoundary','plugin/src/runtime/privacy/boundary.ts',[],['plugin/src/runtime/task/task-runtime.ts'],['plugin/test/hi-core-evolution.test.mjs'],'docs/SECURITY-MODEL.md'),
('scheduler','ConcurrencyScheduler','plugin/src/runtime/scheduler/concurrency.ts',['plugin/src/runtime/scheduler/parallel-safety.ts'],['plugin/src/runtime/task/task-runtime.ts'],['plugin/test/scheduler-hardening.test.mjs'],'docs/VERIFICATION.md'),
