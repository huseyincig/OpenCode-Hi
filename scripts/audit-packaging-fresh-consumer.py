...
row('execute-material-hi-runtime','scripts/run-fresh-consumer-acceptance.py',"'/experimental/tool/ids?'",fresh_rel,'"hi_tool_count": 31')
...
static={
 ...
 'hi_tools_exact':runtime.get('hi_tool_count')==31,
