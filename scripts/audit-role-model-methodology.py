...
CHECKS=[
 ...
 ('model-fallback','plugin/src/runtime/task/task-recovery-coordinator.ts','recoverHostTerminalFailure','plugin/test/provider-fallback-hardening.test.mjs','second provider failure advances to next fallback rather than returning to prior model'),
