...
checks=[
 ...
 ('continuation-port','plugin/src/runtime/continuation/dispatcher.ts',"Pick<HostPort,'continueSession'>",'plugin/test/a6-host-port-typing.test.mjs','alternate host continuation port preserves Mission continuation semantics without OpenCode shapes'),
 ...
 ('missing-capability-fail-closed','plugin/src/runtime/task/task-runtime.ts',"hostCapabilitySource:(()=>readonly HostCapabilityContract[])|readonly HostCapabilityContract[]=[]".replace('= []','= []'),'plugin/test/methodology-host-capability.test.mjs','browser and visual methodologies require canonical browser-execution host capability'),
