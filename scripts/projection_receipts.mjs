...
export function buildProjectionReceipts(root){
  ...
  add('hi.agent-config.v1',[{id:'hi.role.catalog',contract:roleCatalog},{id:'hi.methodology.catalog',contract:methodologyCatalog},{id:'hi.role.guidance',contract:roleGuidance}],'hi.agent-config.generator','plugin/src/generated/agent-config.ts')
