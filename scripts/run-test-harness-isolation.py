...
def isolated_env(sandbox:Path):
    ...
    git_global=sandbox/'gitconfig';git_global.write_text('')
    env={**os.environ,'OPENCODE_HI_STATE_DIR':str(sandbox/'hi-state'),'XDG_STATE_HOME':str(sandbox/'xdg-state'),'XDG_CACHE_HOME':str(sandbox/'xdg-cache'),'XDG_CONFIG_HOME':str(sandbox/'xdg-config'),'GIT_CONFIG_NOSYSTEM':'1','GIT_CONFIG_GLOBAL':str(git_global),'GIT_CONFIG_COUNT':'2','GIT_CONFIG_KEY_0':'core.autocrlf','GIT_CONFIG_VALUE_0':'false','GIT_CONFIG_KEY_1':'core.eol','GIT_CONFIG_VALUE_1':'lf'}
