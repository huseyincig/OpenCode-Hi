...
checks={
 ...
 'unreleased_runtime_change_declared':not (t4 and runtime_drift) or ('## Unreleased' in (ROOT/'CHANGELOG.md').read_text(encoding='utf-8') and cert_head!=release_commit),
}
if t4:
