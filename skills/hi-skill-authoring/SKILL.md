---
name: hi-skill-authoring
description: Create or evolve reusable methodology skills without leaking orchestration ownership.
---
...
- **Trigger:** Reusable methodology must be added or an existing skill materially changed.
- **Do not trigger:** Project facts, one-off evidence, or orchestration policy are being handled.
- **Exit condition:** Trigger, do-not-trigger, exit, methodology, resources, and tests are coherent and non-duplicative.
